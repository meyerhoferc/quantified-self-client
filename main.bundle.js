...
/***/ (function(module, exports, __webpack_require__) {
	...
	function formatFoods(data) {
	  for (var i = 0; i < data.length; i++) {
	    $('tbody').prepend(`<tr id='${data[i].name}'><td><p>${data[i].name}</p></td><td><p>${data[i].calories}</p></td><td><button data-food-id=${data[i].id} id='delete-food-button' class='btn red'>Delete</button></td></tr>`);
	  };
	};
